...
class ViewAllImportantNoteScreen extends StatelessWidget {
  ViewAllImportantNoteScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GetBuilder<NoteController>(
        builder: (_) {
          if(_noteController.isGettingImportantNote){
            return Center(
          ...
          } else if (_noteController.importantNoteList.isEmpty){
            return Center(
              child: Text(
            ...
            return RefreshIndicator(
              onRefresh: () async {
                await _noteController.getAllImportantNotes();
              },
              color: Theme.of(context).primaryColor,
              child: ListView.builder(
                padding: EdgeInsets.all(10.0),
                itemCount: _noteController.importantNoteList.length,
                itemBuilder: (context, index) {
                  final note = _noteController.importantNoteList[index];
